...
- **Straße und Wagen:** Vorne quer über die Platte liegt eine dunkle Straße mit weißen Randlinien.
  ...
  ist offen (Puppenhaus-Prinzip), damit man die Stapel sieht. Im Hochformat schaut die Kamera
  von hinten in den Wagen, dann ist statt der Heckwand nur eine niedrige Kante da.
...
- **Abfahrt:** Der Laderaum ist zu mindestens 60 % gefüllt (nach Volumen), oder keine der fünf
  Größen passt mehr hinein. Ganz voll zu schlichten war zu mühsam. Dann wartet der Wagen kurz und
  fährt nach rechts weg. Fällt der Füllgrad in der Wartezeit durch Herausnehmen wieder unter die
...
| Datei | Aufgabe |
| --- | --- |
| `src/delivery/cargo.js` | Raster, Stapelhöhe, nächster passender Platz, Nachrutschen, Füllgrad und Abfahrbereitschaft |
